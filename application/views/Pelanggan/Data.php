          ...
          <div class="card shadow mb-3">
               <div class="card-body">
                    <div class="table-responsive">
                         <table id="table-pelanggan" class="table table-striped table-bordered table-hover">
                              <thead>
                         ...
                         Swal.fire({
                              ...
                              if (data.status == 1) {
                                   ...
                                   Swal.fire({
                                        ...
                                        location.href = "<?php echo base_url() ?>Pelanggan";
                                   });
...
<script>
     function ubah(id) {
          ...
          $.ajax({
               url: "<?php echo base_url(); ?>Pelanggan/data/?id=" + id,
               type: "GET",
               dataType: "JSON",
               success: function(data) {
                         ...
                         if (data.status == 1) {
                              ...
                              Swal.fire({
                                   ...
                                   if (result.isConfirmed) {
                                        $('#modal-ubah').modal('hide');
                                        $.ajax({
                                             url: "<?php echo base_url(); ?>Pelanggan/ubah_proses",
                                             type: "POST",
                                             data: ($('#form-ubah').serialize()),
                                             dataType: "JSON",
                                             success: function(data) {
                         ...
                         success: function(data) {
                              if (data.status == 1) {
                                   Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                             $.ajax({
                                                  url: "<?php echo base_url(); ?>Pelanggan/hapus_proses/" + id,
                                                  type: "POST",
                                                  data: ($('#form-ubah').serialize()),
                                                  dataType: "JSON",
                                                  success: function(data) {
